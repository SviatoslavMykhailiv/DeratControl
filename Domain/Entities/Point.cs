  ...
  public class Point : AuditableEntity {
    ...
    public int Order {
      ...
      set {
        ...
        var pointWithSameOrderExists = Perimeter.Points.Any(p => p.Order == value && p.Trap == trap);
    ...
    public Trap Trap {
      get => trap;
      set {
        var pointWithSameTrapExists = Perimeter.Points.Any(p => p.Order == order && p.Trap == value);
