        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityFID = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUser_Facility_FacilityFID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SupplementFieldFID = table.Column<Guid>(nullable: false),
                    ModifiedAt = table.Column<DateTime>(nullable: false),
                    ModifiedBy = table.Column<Guid>(nullable: false),
                    SupplementFID = table.Column<Guid>(nullable: false),
                    FieldName = table.Column<string>(nullable: true),
                    Order = table.Column<int>(nullable: false),
                    SupplementFieldType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplementField", x => x.SupplementFieldFID);
                    table.ForeignKey(
                        name: "FK_SupplementField_Supplement_SupplementFID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DefaultFacility_ApplicationUser_UserFID",
                        column: x => x.UserFID,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Errand_ApplicationUser_EmployeeFID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointReviewRecord_SupplementField_SupplementFieldID",
                        column: x => x.SupplementFieldID,
                        principalTable: "SupplementField",
                        principalColumn: "SupplementFieldFID",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUser_FacilityFID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointReviewRecord_SupplementFieldID",
                table: "PointReviewRecord",
                column: "SupplementFieldID");

            migrationBuilder.CreateIndex(
                name: "IX_SupplementField_SupplementFID",
                table: "SupplementField",
                column: "SupplementFID");
        }
